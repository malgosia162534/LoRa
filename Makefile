#
# OMNeT++/OMNEST Makefile for LoRa-master
#
...
INCLUDE_PATH = -I. -Iresults -Isimulations -Isrc
...
clean:
	$(qecho) Cleaning...
	$(Q)-rm -rf $O
	$(Q)-rm -f LoRa-master LoRa-master.exe libLoRa-master.so libLoRa-master.a libLoRa-master.dll libLoRa-master.dylib
